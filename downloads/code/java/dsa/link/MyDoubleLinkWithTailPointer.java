...
public class MyDoubleLinkWithTailPointer {
    ...
    public static void main(String[] args) {
        int capacity = 7;
        MyDoubleLinkWithTailPointer link = new MyDoubleLinkWithTailPointer();
    ...
    public static void test1(MyDoubleLinkWithTailPointer link, int capacity) {
    ...
    public static void test2(MyDoubleLinkWithTailPointer link, int capacity) {
